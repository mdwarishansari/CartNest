      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-8 py-20 text-center relative z-10">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Start Selling on CartNest</h2>
            <p className="text-indigo-100 mb-8 text-lg max-w-xl mx-auto leading-relaxed">
              Join our growing marketplace. Create your shop, list products, and start earning — it&apos;s free to get started.
            </p>
            <Link
              to="/seller/signup"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-indigo-700 font-bold rounded-xl shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all text-base"
            >
