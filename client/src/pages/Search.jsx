...
const Search = () => {
  ...
  }, [debouncedFilters, categories, searchParams, setSearchParams, retryTrigger]);
          ...
          <div className="flex-1 min-w-0">
            ...
            {loading ? (
              ...
              <ErrorState
                ...
                message="We encountered an error retrieving search results. Please check your connection and try again."
